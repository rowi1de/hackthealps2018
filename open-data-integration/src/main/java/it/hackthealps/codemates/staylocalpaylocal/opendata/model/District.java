...
public class District {
  ...
  public District isComune(Boolean isComune) {
  ...
  **/
  ...
  public District regionId(String regionId) {
  ...
  **/
  ...
  public District tourismvereinId(String tourismvereinId) {
  ...
  **/
  ...
  public District municipalityId(String municipalityId) {
  ...
  **/
  ...
  public District siagId(String siagId) {
    this.siagId = siagId;
    return this;
  }
  ...
  **/
  ...
  public District gpsPolygon(List<GpsPolygon> gpsPolygon) {
    this.gpsPolygon = gpsPolygon;
    return this;
  }

  public District addGpsPolygonItem(GpsPolygon gpsPolygonItem) {
  ...
  **/
  ...
  public District webcam(List<Webcam> webcam) {
    this.webcam = webcam;
    return this;
  }

  public District addWebcamItem(Webcam webcamItem) {
    if (this.webcam == null) {
  ...
  **/
  ...
  public District visibleInSearch(Boolean visibleInSearch) {
  ...
  **/
  ...
  public District customId(String customId) {
  ...
  **/
  ...
  public District shortname(String shortname) {
  ...
  **/
  ...
  public District gpstype(String gpstype) {
  ...
  **/
  ...
  public District altitude(Double altitude) {
  ...
  **/
  ...
  public District altitudeUnitofMeasure(String altitudeUnitofMeasure) {
  ...
  **/
  ...
  public District detail(Map<String, Detail> detail) {
    this.detail = detail;
    return this;
  }

  public District putDetailItem(String key, Detail detailItem) {
    if (this.detail == null) {
  ...
  **/
  ...
  public District contactInfos(Map<String, ContactInfos> contactInfos) {
    this.contactInfos = contactInfos;
    return this;
  }

  public District putContactInfosItem(String key, ContactInfos contactInfosItem) {
  ...
  **/
  ...
  public District imageGallery(List<ImageGallery> imageGallery) {
    this.imageGallery = imageGallery;
    return this;
  }

  public District addImageGalleryItem(ImageGallery imageGalleryItem) {
  ...
  **/
  ...
  public District smgTags(List<String> smgTags) {
    this.smgTags = smgTags;
    return this;
  }

  public District addSmgTagsItem(String smgTagsItem) {
  ...
  **/
  ...
  public District smgActive(Boolean smgActive) {
  ...
  **/
  ...
  public District hasLanguage(List<String> hasLanguage) {
    this.hasLanguage = hasLanguage;
    return this;
  }

  public District addHasLanguageItem(String hasLanguageItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.isComune, district.isComune) &&
        Objects.equals(this.regionId, district.regionId) &&
        Objects.equals(this.tourismvereinId, district.tourismvereinId) &&
        Objects.equals(this.municipalityId, district.municipalityId) &&
        Objects.equals(this.siagId, district.siagId) &&
        Objects.equals(this.gpsPolygon, district.gpsPolygon) &&
        Objects.equals(this.webcam, district.webcam) &&
        Objects.equals(this.visibleInSearch, district.visibleInSearch) &&
        Objects.equals(this.id, district.id) &&
        Objects.equals(this.active, district.active) &&
        Objects.equals(this.customId, district.customId) &&
        Objects.equals(this.shortname, district.shortname) &&
        Objects.equals(this.gpstype, district.gpstype) &&
        Objects.equals(this.latitude, district.latitude) &&
        Objects.equals(this.longitude, district.longitude) &&
        Objects.equals(this.altitude, district.altitude) &&
        Objects.equals(this.altitudeUnitofMeasure, district.altitudeUnitofMeasure) &&
        Objects.equals(this.detail, district.detail) &&
        Objects.equals(this.contactInfos, district.contactInfos) &&
        Objects.equals(this.imageGallery, district.imageGallery) &&
        Objects.equals(this.smgTags, district.smgTags) &&
        Objects.equals(this.smgActive, district.smgActive) &&
        Objects.equals(this.hasLanguage, district.hasLanguage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isComune, regionId, tourismvereinId, municipalityId, siagId, gpsPolygon, webcam, visibleInSearch, id, active, customId, shortname, gpstype, latitude, longitude, altitude, altitudeUnitofMeasure, detail, contactInfos, imageGallery, smgTags, smgActive, hasLanguage);
  }
