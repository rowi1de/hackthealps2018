...
public class TvInfo {
  ...
  **/
  ...
  public TvInfo name(Map<String, String> name) {
    this.name = name;
    return this;
  }

  public TvInfo putNameItem(String key, String nameItem) {
    if (this.name == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TvInfo tvInfo = (TvInfo) o;
    return Objects.equals(this.id, tvInfo.id) &&
        Objects.equals(this.name, tvInfo.name);
  }
