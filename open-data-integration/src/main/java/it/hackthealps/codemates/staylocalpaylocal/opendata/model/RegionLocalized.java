...
public class RegionLocalized {
  ...
  public RegionLocalized detailThemed(DetailThemed detailThemed) {
  ...
  **/
  ...
  public RegionLocalized gpsPolygon(List<GpsPolygon> gpsPolygon) {
    this.gpsPolygon = gpsPolygon;
    return this;
  }

  public RegionLocalized addGpsPolygonItem(GpsPolygon gpsPolygonItem) {
  ...
  **/
  ...
  public RegionLocalized webcam(List<WebcamLocalized> webcam) {
    this.webcam = webcam;
    return this;
  }

  public RegionLocalized addWebcamItem(WebcamLocalized webcamItem) {
    if (this.webcam == null) {
  ...
  **/
  ...
  public RegionLocalized visibleInSearch(Boolean visibleInSearch) {
  ...
  **/
  ...
  public RegionLocalized skiareaIds(List<String> skiareaIds) {
    this.skiareaIds = skiareaIds;
    return this;
  }

  public RegionLocalized addSkiareaIdsItem(String skiareaIdsItem) {
  ...
  **/
  ...
  public RegionLocalized id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public RegionLocalized active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public RegionLocalized customId(String customId) {
  ...
  **/
  ...
  public RegionLocalized shortname(String shortname) {
  ...
  **/
  ...
  public RegionLocalized gpstype(String gpstype) {
  ...
  **/
  ...
  public RegionLocalized latitude(Double latitude) {
  ...
  **/
  ...
  public RegionLocalized longitude(Double longitude) {
  ...
  **/
  ...
  public RegionLocalized altitude(Double altitude) {
  ...
  **/
  ...
  public RegionLocalized altitudeUnitofMeasure(String altitudeUnitofMeasure) {
  ...
  **/
  ...
  public RegionLocalized detail(Detail detail) {
    this.detail = detail;
    return this;
  }
  ...
  **/
  ...
  public RegionLocalized contactInfos(ContactInfos contactInfos) {
  ...
  **/
  ...
  public RegionLocalized imageGallery(List<ImageGalleryLocalized> imageGallery) {
    this.imageGallery = imageGallery;
    return this;
  }

  public RegionLocalized addImageGalleryItem(ImageGalleryLocalized imageGalleryItem) {
  ...
  **/
  ...
  public RegionLocalized smgTags(List<String> smgTags) {
    this.smgTags = smgTags;
    return this;
  }

  public RegionLocalized addSmgTagsItem(String smgTagsItem) {
  ...
  **/
  ...
  public RegionLocalized smgActive(Boolean smgActive) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RegionLocalized regionLocalized = (RegionLocalized) o;
    return Objects.equals(this.detailThemed, regionLocalized.detailThemed) &&
        Objects.equals(this.gpsPolygon, regionLocalized.gpsPolygon) &&
        Objects.equals(this.webcam, regionLocalized.webcam) &&
        Objects.equals(this.visibleInSearch, regionLocalized.visibleInSearch) &&
        Objects.equals(this.skiareaIds, regionLocalized.skiareaIds) &&
        Objects.equals(this.id, regionLocalized.id) &&
        Objects.equals(this.active, regionLocalized.active) &&
        Objects.equals(this.customId, regionLocalized.customId) &&
        Objects.equals(this.shortname, regionLocalized.shortname) &&
        Objects.equals(this.gpstype, regionLocalized.gpstype) &&
        Objects.equals(this.latitude, regionLocalized.latitude) &&
        Objects.equals(this.longitude, regionLocalized.longitude) &&
        Objects.equals(this.altitude, regionLocalized.altitude) &&
        Objects.equals(this.altitudeUnitofMeasure, regionLocalized.altitudeUnitofMeasure) &&
        Objects.equals(this.detail, regionLocalized.detail) &&
        Objects.equals(this.contactInfos, regionLocalized.contactInfos) &&
        Objects.equals(this.imageGallery, regionLocalized.imageGallery) &&
        Objects.equals(this.smgTags, regionLocalized.smgTags) &&
        Objects.equals(this.smgActive, regionLocalized.smgActive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detailThemed, gpsPolygon, webcam, visibleInSearch, skiareaIds, id, active, customId, shortname, gpstype, latitude, longitude, altitude, altitudeUnitofMeasure, detail, contactInfos, imageGallery, smgTags, smgActive);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegionLocalized {\n");
