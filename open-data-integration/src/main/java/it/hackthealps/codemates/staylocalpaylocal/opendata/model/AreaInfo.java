...
public class AreaInfo {
  ...
  **/
  ...
  public AreaInfo name(Map<String, String> name) {
    this.name = name;
    return this;
  }

  public AreaInfo putNameItem(String key, String nameItem) {
    if (this.name == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, areaInfo.id) &&
        Objects.equals(this.name, areaInfo.name);
  }
