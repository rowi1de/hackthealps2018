...
public class TourismvereinLocalized {
  ...
  public TourismvereinLocalized regionId(String regionId) {
  ...
  **/
  ...
  public TourismvereinLocalized gpsPolygon(List<GpsPolygon> gpsPolygon) {
    this.gpsPolygon = gpsPolygon;
    return this;
  }

  public TourismvereinLocalized addGpsPolygonItem(GpsPolygon gpsPolygonItem) {
  ...
  **/
  ...
  public TourismvereinLocalized webcam(List<WebcamLocalized> webcam) {
    this.webcam = webcam;
    return this;
  }

  public TourismvereinLocalized addWebcamItem(WebcamLocalized webcamItem) {
    if (this.webcam == null) {
  ...
  **/
  ...
  public TourismvereinLocalized visibleInSearch(Boolean visibleInSearch) {
  ...
  **/
  ...
  public TourismvereinLocalized skiareaIds(List<String> skiareaIds) {
    this.skiareaIds = skiareaIds;
    return this;
  }

  public TourismvereinLocalized addSkiareaIdsItem(String skiareaIdsItem) {
  ...
  **/
  ...
  public TourismvereinLocalized id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TourismvereinLocalized active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public TourismvereinLocalized customId(String customId) {
  ...
  **/
  ...
  public TourismvereinLocalized shortname(String shortname) {
  ...
  **/
  ...
  public TourismvereinLocalized gpstype(String gpstype) {
  ...
  **/
  ...
  public TourismvereinLocalized latitude(Double latitude) {
  ...
  **/
  ...
  public TourismvereinLocalized longitude(Double longitude) {
  ...
  **/
  ...
  public TourismvereinLocalized altitude(Double altitude) {
  ...
  **/
  ...
  public TourismvereinLocalized altitudeUnitofMeasure(String altitudeUnitofMeasure) {
  ...
  **/
  ...
  public TourismvereinLocalized detail(Detail detail) {
    this.detail = detail;
    return this;
  }
  ...
  **/
  ...
  public TourismvereinLocalized contactInfos(ContactInfos contactInfos) {
  ...
  **/
  ...
  public TourismvereinLocalized imageGallery(List<ImageGalleryLocalized> imageGallery) {
    this.imageGallery = imageGallery;
    return this;
  }

  public TourismvereinLocalized addImageGalleryItem(ImageGalleryLocalized imageGalleryItem) {
  ...
  **/
  ...
  public TourismvereinLocalized smgTags(List<String> smgTags) {
    this.smgTags = smgTags;
    return this;
  }

  public TourismvereinLocalized addSmgTagsItem(String smgTagsItem) {
  ...
  **/
  ...
  public TourismvereinLocalized smgActive(Boolean smgActive) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TourismvereinLocalized tourismvereinLocalized = (TourismvereinLocalized) o;
    return Objects.equals(this.regionId, tourismvereinLocalized.regionId) &&
        Objects.equals(this.gpsPolygon, tourismvereinLocalized.gpsPolygon) &&
        Objects.equals(this.webcam, tourismvereinLocalized.webcam) &&
        Objects.equals(this.visibleInSearch, tourismvereinLocalized.visibleInSearch) &&
        Objects.equals(this.skiareaIds, tourismvereinLocalized.skiareaIds) &&
        Objects.equals(this.id, tourismvereinLocalized.id) &&
        Objects.equals(this.active, tourismvereinLocalized.active) &&
        Objects.equals(this.customId, tourismvereinLocalized.customId) &&
        Objects.equals(this.shortname, tourismvereinLocalized.shortname) &&
        Objects.equals(this.gpstype, tourismvereinLocalized.gpstype) &&
        Objects.equals(this.latitude, tourismvereinLocalized.latitude) &&
        Objects.equals(this.longitude, tourismvereinLocalized.longitude) &&
        Objects.equals(this.altitude, tourismvereinLocalized.altitude) &&
        Objects.equals(this.altitudeUnitofMeasure, tourismvereinLocalized.altitudeUnitofMeasure) &&
        Objects.equals(this.detail, tourismvereinLocalized.detail) &&
        Objects.equals(this.contactInfos, tourismvereinLocalized.contactInfos) &&
        Objects.equals(this.imageGallery, tourismvereinLocalized.imageGallery) &&
        Objects.equals(this.smgTags, tourismvereinLocalized.smgTags) &&
        Objects.equals(this.smgActive, tourismvereinLocalized.smgActive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regionId, gpsPolygon, webcam, visibleInSearch, skiareaIds, id, active, customId, shortname, gpstype, latitude, longitude, altitude, altitudeUnitofMeasure, detail, contactInfos, imageGallery, smgTags, smgActive);
  }
  ...
  public String toString() {
    ...
    sb.append("class TourismvereinLocalized {\n");
